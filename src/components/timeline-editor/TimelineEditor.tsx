    ...
    (e: MouseEvent) => {
      ...
      setTempSubtitles((subs) =>
        subs.map((sub) => {
          ...
          return {
            ...sub,
            startTime: secondsToVtt(start),
            endTime: secondsToVtt(end),
          };
        })
      );
    },
      ...
      <div className="flex items-center justify-between px-2 py-1 bg-gray-800 rounded">
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="ghost"
            onClick={() =>
              activeSubtitleId && onDeleteSubtitle(activeSubtitleId)
            }
      ...
      >
        <div style={{ width: timelineWidth }} className="relative">
          ...
          <div className="flex flex-col gap-2 pt-6">
              ...
              {displaySubtitles.map((sub) => {
                ...
                return (
                  ...
                  >
                    <div
                      onMouseDown={(e) =>
                        handleMouseDown(e, sub.id, 'move')
                      }
                      className={`h-full px-2 text-xs flex items-center bg-yellow-500 text-black rounded ${
            ...
            {/* ✅ MATCHES EXISTING COMPONENT API */}
            <VideoThumbnails
