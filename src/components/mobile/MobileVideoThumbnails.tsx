...
const MobileVideoThumbnails = ({ videoPublicId, duration, timelineWidth }: VideoThumbnailsProps) => {
  ...
  if (thumbnails.length === 0) {
    return (
      <div className="h-10 bg-gray-800/50 rounded-md flex items-center justify-center text-gray-400 text-sm">
  ...
  return (
    <div className="h-10 relative overflow-hidden rounded-md bg-gray-800/50 flex">
...
export default React.memo(MobileVideoThumbnails);
